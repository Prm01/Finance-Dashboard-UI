          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {!isAuthed ? (
              <>
                ...
                <Link
                  to="/signup"
                  className="inline-flex items-center gap-1.5 rounded-lg dark:bg-gradient-to-r dark:from-teal-500 dark:to-lime-500 bg-gradient-to-r from-teal-600 to-lime-600 px-3 py-1.5 text-xs sm:text-sm font-semibold dark:text-gray-900 text-white transition-all duration-200 dark:hover:shadow-teal-glow-hover hover:shadow-lg"
                >
                  <UserPlus size={14} />

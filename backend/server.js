...
//       return callback(new Error(`CORS blocked for origin: ${origin}. Allowed: localhost/127.0.0.1/local network IPs on ports 5173-5180 and configured frontend origins`));
//     } catch (error) {
//       // Invalid URL format
